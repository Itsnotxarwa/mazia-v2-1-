            ...
            <section className="lg:py-24 py-12">
                ...
                <div className="space-x-6 flex flex-col lg:flex-row items-center space-y-6  mx-6 lg:mx-12">
                    <div className="max-w-3xl">
                            ...
                            Renseignez vos coordonnées et notre agent conversationnel vous rappellera instantanément  pour vous présenter nos solutions et répondre à toutes vos questions.
                            </p>
