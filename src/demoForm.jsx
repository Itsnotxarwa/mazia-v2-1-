            ...
            <div className="w-full grid grid-cols-2 gap-4">
             ...
             {phoneError && <p style={{ color: "red" }}>{phoneError}</p>}
                ...
                {!loading ? (
                    ...
                    : "bg-transparent border border-black hover:bg-black hover:text-white transition-all duration-300 font-medium hover:scale-105 text-black cursor-pointer"}
                    `}
                    >
                        Se faire appeler
                    </button>
                    ...
                    <div className="flex items-center gap-3">
                        ...
                        <span className="text-lg text-black/60">Veuillez patienter, vous allez recevoir un appel.</span>
                    </div>
                )}
                </div>
            </form>
